<!--    Special Price   -->
<?php
//if we want to add new brand &then automatically it creates
//button for new brand to filter its products at 
//special price section of page 
...
<section id="special-price">
    <div class="container">
        ...
        <div id="filters" class="button-group text-right font-baloo font-size-16">
            <button class="btn is-chcecked" data-filter="*">All Brands</button>  
            <?php
