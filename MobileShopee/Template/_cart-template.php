    ...
    <div class="container-fluid w-85">
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                ?>
             <!--cart item add required products-->
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                       ...
                       <div class="d-flex">
                        ...
                        <a href="#" class="px-3 font-rale font-size-14">20,534 ratings</a>
                    </div>
                       <!--!product rating-->
                       ...
                       <div class="qty d-flex pt-2">
                           <div class="d-flex font-rale w-25">
                                ...
                                <input type="text" data-id="<?php echo $item['item_id'] ?? '0';?>" class="qty_input border px-1 w-100 bg-light" disabled value="1" placeholder="1">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">                 <!--used 2 span tags to separate $ and number , this will reduce our work at back end-->
